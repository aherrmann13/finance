...
import com.finance.service.endpoints.definitions.{Asset, Record, RecordQuery, Transaction, Transfer}
...
object RecordMapping {
  ...
  implicit val recordResponseMapping: Mapping[RecordModel, Record] = {
    ...
    case TransferRecord(value) => Record(transaction = None, transfer = Some(value.mapTo[Transfer]), asset = None)
  }
}
